...
import (
	...
	"github.com/Sonu-kumar54/mongo-api/models"
	"github.com/Sonu-kumar54/mongo-api/responses"
...
func GetAUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			response := responses.UserResponse{Status: http.StatusNotFound, Message: "Not found", Data: map[string]interface{}{"data": err.Error()}}
			json.NewEncoder(rw).Encode(response)
			return
		}
...
func UpdateAUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		ctx, cancel := context.WithTimeout(context.Background(), 10*time.Second)
		params := mux.Vars(r)
		userId := params["userId"]
